...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) + "/altproduct/"

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.1/howto/deployment/checklist/
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "csSZmMP!8zX{IvK;f%,d:#tU"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'vegalt',
        'USER': os.getenv('vegalt_db_user'),
        'PASSWORD': os.getenv('vegalt_db_password'),
        'HOST': os.getenv('vegalt_db_host'),
        'PORT': os.getenv('vegalt_db_port'),
    }
}
